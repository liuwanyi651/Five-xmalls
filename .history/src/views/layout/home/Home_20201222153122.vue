<template>
  <div class="conbox">
    ...
    <!---热门商品-->
    <div class="picurlbox bs bor-r20">
      <div class="picurlbg">热门商品</div>
      <div class="picurlimg flex j-betw">
        <div class="picurl" v-for="(item, index) in hotShop" :key="index"></div>
      </div>
    </div>

    <div class="hot">热门商品</div>
    <div class="hu">
      <div v-for="(item, index) in list2" :key="index" class="da">
        <div>
