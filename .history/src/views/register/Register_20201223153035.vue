      ...
      <div class="loginbox">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleInline" inline>
          ...
          <FormItem prop="repassword" class="input">
            <Input type="password" v-model="formInline.password" placeholder="重复密码" size="large"/>
          </FormItem>
          ...
          <FormItem>
            <div>
            <Button type="primary" size="large" class="btn" @click="handleSubmit('formInline')">注册</Button>
            </div>
